...
<tr>
<td><h1 style="color:red" align="center"><u>Patient</u></h1></td><br>
</tr>
<tr>
...
<a href="patientinfo.php" target="jh"><h1 align="left">
...
$id = $_POST['id'];
$pwd = $_POST['pass'];
$query = "SELECT * FROM PATIENT2 WHERE id='$id' && password='$pwd'";
